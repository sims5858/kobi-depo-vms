        ...
        <div className="d-flex justify-content-between align-items-center py-3">
          ...
          <div className="d-flex flex-wrap gap-2 align-items-center">
            ...
            <Button variant="info" onClick={handleExportExcel} className="d-flex align-items-center">
              <BiDownload className="me-1" /> Excel Aktar
            </Button>
      ...
      <Card className="anim-fade-in delay-1" style={{ height: 'calc(100vh - 200px)', overflow: 'hidden', width: '100%' }}>
        <Card.Body style={{ height: '100%', display: 'flex', flexDirection: 'column', padding: '1rem' }}>
          <div className="d-flex justify-content-between align-items-center mb-3">
            <h5 className="card-title mb-0">Ürün Listesi ({filteredUrunListesi.length} ürün)</h5>
          </div>
            ...
            <>
              <div className="flex-grow-1" style={{ 
                ...
                <Table striped hover className="mb-0" style={{ minWidth: '1200px' }}>
                  <thead style={{ backgroundColor: '#f8f9fa', position: 'sticky', top: 0, zIndex: 10 }}>
                    <tr>
                      <th style={{ minWidth: '150px', width: '150px' }}>Barkod</th>
                      <th style={{ minWidth: '200px', width: '200px' }}>Ürün Adı</th>
                      <th style={{ minWidth: '120px', width: '120px' }}>Kategori</th>
                      <th style={{ minWidth: '80px', width: '80px' }}>Birim</th>
                      <th style={{ minWidth: '100px', width: '100px' }}>Stok Miktarı</th>
                      <th style={{ minWidth: '150px', width: '150px' }}>Lokasyon</th>
                      <th style={{ minWidth: '120px', width: '120px' }}>Koli</th>
                      <th style={{ minWidth: '100px', width: '100px' }}>Raf Ömrü</th>
                      <th style={{ minWidth: '150px', width: '150px' }}>Tedarikçi</th>
                      <th style={{ minWidth: '120px', width: '120px' }}>Oluşturma Tarihi</th>
                      <th style={{ minWidth: '120px', width: '120px' }}>İşlemler</th>
                    </tr>
                  </thead>
                  <tbody>
                    {currentItems.map((urun) => (
                      <tr key={urun.id}>
                        <td style={{ minWidth: '150px', width: '150px' }}><code>{urun.barkod}</code></td>
                        <td style={{ minWidth: '200px', width: '200px' }}>{urun.urun_adi}</td>
                        <td style={{ minWidth: '120px', width: '120px' }}>{urun.kategori}</td>
                        <td style={{ minWidth: '80px', width: '80px' }}>{urun.birim}</td>
                        <td style={{ minWidth: '100px', width: '100px' }}>{urun.stok_miktari}</td>
                        <td style={{ minWidth: '150px', width: '150px' }}>{urun.lokasyon || 'N/A'}</td>
                        <td style={{ minWidth: '120px', width: '120px' }}>{urun.koli || 'N/A'}</td>
                        <td style={{ minWidth: '100px', width: '100px' }}>{urun.raf_omru} Gün</td>
                        <td style={{ minWidth: '150px', width: '150px' }}>{urun.tedarikci}</td>
                        <td style={{ minWidth: '120px', width: '120px' }}>{urun.olusturma_tarihi ? new Date(urun.olusturma_tarihi).toLocaleDateString('tr-TR') : 'N/A'}</td>
