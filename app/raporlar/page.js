...
import { BiBarChart, BiDownload, BiRefresh, BiFileText, BiTrendingUp } from 'react-icons/bi';
    ...
    <div className="page-transition">
      ...
      <Row className="mb-4">
        ...
        <Col md={3}>
          <Card className="text-center">
            <Card.Body>
              <BiFileText size={32} className="text-info mb-2" />
